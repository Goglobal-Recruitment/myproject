(self["b-index-lp-web-mfe__LOADABLE_LOADED_CHUNKS__"] = self["b-index-lp-web-mfe__LOADABLE_LOADED_CHUNKS__"] || []).push([
    ["80108a6f"], {
        a6c91b97: (A, g, e) => {
            ...
            }, s.resolve = B, A.exports = s, s.id = "a6c91b97"
        },
        "94af1fdb": (A, g, e) => {
            "use strict";
            e.r(g), e.d(g, {
            ...
            const z = A => {
                let {
                    ...
                    alt: l,
                    flagAlt: z,
                    shouldAriaHideImage: V = !1,
                    shouldAriaHideImageFlag: K = !1
                } = A;
                const [J, C] = (0, a.useState)(void 0), [j, k] = (0, n.YD)({
                    threshold: 0,
                    triggerOnce: !0
                }), H = (0, E.trackExperiment)(E.exp `OAYRKHMbddbSLAISRaRbAMFRURURHe`), f = (0, U.isFeatureRunning)(U.feature `OAYRKHMbddbSLAISRaRbAMFRURURYUbCBMeOFXPVMHUO`) ? M.Square : M.Circle;
                (0, a.useEffect)((() => {
                    if (B) {
                        let A;
                        try {
                            if (H && f === M.Square) {
                                const A = B.charAt(0).toUpperCase() + B.charAt(1).toLowerCase(),
                                    g = (0, c.hX)({
                                        setName: "images-flags",
                                        assetName: A
                                    }) || "";
                                C(g)
                            } else A = e("a6c91b97")(`./${B}.png`), C(A)
                        } catch {}
                    }
                }), [B, f, H]);
                (0, a.useEffect)((() => {
                ...
                return s().createElement(i.Actionable, {
                    href: d,
                    className: D,
                    onClick: () => {
                        I && I()
                    ...
                    ref: j
                }, s().createElement(i.Scrim, {
                    className: T,
                    borderRadius: 200,
                    backgroundSlot: s().createElement(i.AspectRatio, {
                        ratio: t || r.L["2:1"],
                        width: "100%"
                    }, s().createElement(i.Image, (0, S.Z)({
                        src: R,
                        alt: l
                    }, V && {
                        alt: ""
                    ...
                    position: "top",
                    attributes: {
                        "data-testid": `destination-postcard-${o}`
                    }
                }, s().createElement(i.Title, {
                    color: "inherit",
                    title: s().createElement(s().Fragment, null, s().createElement("span", {
                        className: `${b} ${(A=>A.split(" ").some((A=>A.length>16)))(g)?X:""}`
                    }, g), H ? f === M.Square ? s().createElement(i.Image, (0, S.Z)({
                        width: "24px",
                        src: J,
                        className: m,
                        alt: z
            ...
            var V = e("8ebac256");
            const K = () => s().createElement(i.Stack, {
                gap: 4
            }, s().createElement(i.Stack, {
                direction: "row",
                gap: 4
            }, [0, 1].map((A => s().createElement(i.Stack.Item, {
                grow: !0,
                key: A
            }, s().createElement(i.SkeletonLoader, {
                variant: "box",
                aspectRatio: r.L["2:1"]
            }))))), s().createElement(i.Stack, {
                direction: "row",
                gap: 4
            }, [2, 3, 4].map((A => s().createElement(i.Stack.Item, {
                grow: !0,
                key: A
            }, s().createElement(i.SkeletonLoader, {
                variant: "box",
            ...
            var k = e("2e96c3d5"),
                ...
                f = e("dfb9cb18");
            const w = A => {
                const g = (0, t.getRequestContext)().getBasePageUrl().searchParams,
                    e = (0, f.m)(g),
                    {
                        loading: a,
                        data: s,
                ...
                return B && (0, J.reportError)(B), (A => {
                    var g;
                    let {
                        carouselDML: e,
                        isLoading: a,
                        shouldAdjustImageSize: s
                    } = A;
                    const B = (0, t.getRequestContext)().getCDNOrigin(),
                        R = null === e || void 0 === e ? void 0 : e.destinationRecommendations,
                        n = [],
                        r = A => s ? (A => 0 === A || 1 === A)(A) ? "540x270" : "354x266" : "600x600";
                    return null === R || void 0 === R || null === (g = R.destinations) || void 0 === g || g.forEach(((A, g) => {
                        n.push({
                            ...
                            imgSrc: (0, j.Z)(null === A || void 0 === A ? void 0 : A.imageUrl, r(g), B) || "",
            ...
            const L = () => {
                const A = E.exp `cCHObTULHfAFFQZcNHFXbEIdAJOdKNKNKWe`,
                    g = E.exp `OAYRKHMdReLDEZREScXQOVZQOQCXNLOLOLMO`,
                    e = !!(0, E.trackExperiment)(A),
                    a = w(e),
                    B = a.heading,
                    S = a.subHeading,
                    c = null === a || void 0 === a ? void 0 : a.items,
                    U = a.isWarmStart,
                    D = "us" === (0, t.getRequestContext)().getVisitorCountry(),
                    T = null === c || void 0 === c ? void 0 : c.slice(0, 2),
                    b = null === c || void 0 === c ? void 0 : c.slice(2, 5),
                    X = 2 === (null === T || void 0 === T ? void 0 : T.length),
                    m = 3 === (null === b || void 0 === b ? void 0 : b.length),
                    M = null === c || void 0 === c ? void 0 : c.map((A => ({
                        ufi: A.id
                    }))),
                    J = e => {
                        var a, s;
                        a = e, s = M || [], V.Z.sendEvent({
                        ...
                        }), (0, E.trackCustomGoal)(A, 1), (0, E.trackCustomGoal)(g, 3), (0, u.Ht)(), (0, h.uB)(), D || (U ? (0, E.trackCustomGoal)(E.exp `OAYRKHMdReLDEZRdHeSaeZTUPACQKGUUZaTCCDdKNKNKWe`, 1) : (0, E.trackCustomGoal)(E.exp `OAYRKHMdReLDEZRdHeSaeZTUPACQKGUUHGaQFRURURHe`, 1)), (0, E.trackCustomGoal)(E.exp `OAYRKHMbddbSLAISRaRbAMFRURURHe`, 1)
                    };
                if (a.isLoading && 0 === (null === c || void 0 === c ? void 0 : c.length)) return null;
                if (!a.isLoading) {
                    if (!X) return null;
                    (0, E.trackExperimentStage)(E.exp `OAYRKHMbddbSLAISRaRbAMFRURURHe`, 1), D && (0, E.trackExperimentStage)(E.exp `OAYRKHMbddbSLAISRaRbAMFRURURHe`, 2)
                }
                const C = B && X,
                    j = r.L["4:3"];
                return s().createElement(n.df, {
                    onChange: g => {
                        var e;
                        g && null !== M && void 0 !== M && M.length && (e = M, V.Z.sendEvent({
                            action_name: "webcoreux.destination_recommender_viewed",
                            action_version: "1.0.0",
                            content: {
                                postcards: e
                            }
                        })), g && ((0, E.trackCustomGoal)(E.exp `OAYRKHMbddbSLAISRaRbAMFRURURHe`, 2), (0, E.trackExperimentStage)(A, 1), D || (U ? ((0, E.trackExperimentStage)(E.exp `OAYRKHMdReLDEZRdHeSaeZTUPACQKGUUZaTCCDdKNKNKWe`, 3), (0, E.trackCustomGoal)(E.exp `OAYRKHMdReLDEZRdHeSaeZTUPACQKGUUZaTCCDdKNKNKWe`, 2)) : ((0, E.trackExperimentStage)(E.exp `OAYRKHMdReLDEZRdHeSaeZTUPACQKGUUHGaQFRURURHe`, 3), (0, E.trackCustomGoal)(E.exp `OAYRKHMdReLDEZRdHeSaeZTUPACQKGUUHGaQFRURURHe`, 2))))
                    },
                    className: "keep"
                }, a.isLoading ? s().createElement(K, null) : s().createElement(s().Fragment, null, C ? s().createElement("div", {
                    className: d,
                    ...
                    role: "none"
                }, null === T || void 0 === T ? void 0 : T.map((A => {
                    let {
                        heading: g,
                        imgSrc: e,
                        countryCode: a,
        ...
        dfb9cb18: (A, g, e) => {
            ...
            var a = e("3d486da1"),
                s = e("2bb3685b");
            const B = A => 0 === Object.keys(A).length || "prod" === (0, a.dU)() ? {} : {
                    "X-Booking-Dev-Service-Override": JSON.stringify(A)
                },
                R = A => {
                    const g = {};
                    return s.gh.forEach((e => {
                        const a = A.get(`dev_${e}`);
                        a && (g[e] = a)
                    })), g
                }
        },
        ...
        "125a0ea0": (A, g, e) => {
            "use strict";
            A.exports = e.p + "static/media/aq.2e549b95.png"
        },
        e6dce2b6: A => {
            "use strict";
        ...
        "38f97126": (A, g, e) => {
            "use strict";
            A.exports = e.p + "static/media/bl.44d9e344.png"
        },
        a489fcfc: A => {
            "use strict";
        ...
        fee45f7e: (A, g, e) => {
            "use strict";
            A.exports = e.p + "static/media/io.7729d67a.png"
        },
        "5e442242": A => {
            "use strict";
        ...
        "56fa7774": (A, g, e) => {
            "use strict";
            A.exports = e.p + "static/media/je.52601cb9.png"
        },
        "48e2c15b": A => {
            "use strict";
        ...
        f4430455: (A, g, e) => {
            "use strict";
            A.exports = e.p + "static/media/pm.6b1392d5.png"
        },
        edf95af3: A => {
            "use strict";
        ...
        "641beee2": (A, g, e) => {
            "use strict";
            A.exports = e.p + "static/media/ve.a7f1a604.png"
        },
        "7885ddcf": A => {
            "use strict";
...
//# sourceMappingURL=https://istatic.booking.com/internal-static/capla/static/js/80108a6f.6a2bcb9e.chunk.js.map