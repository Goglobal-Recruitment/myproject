/*! For license information please see ace575b5.c42e9f72.chunk.js.LICENSE.txt */
(self["b-index-lp-web-mfe__LOADABLE_LOADED_CHUNKS__"] = self["b-index-lp-web-mfe__LOADABLE_LOADED_CHUNKS__"] || []).push([
    ["ace575b5", "572dba2c", "1faad75c", "bf5d442e", "1d36ff76", "80108a6f"], {
        a6c91b97: (A, e, g) => {
            var t = {
                "./ad.png": "1b0e14ba",
                "./ae.png": "79f4f2b2",
            ...
            }, n.resolve = a, A.exports = n, n.id = "a6c91b97"
        },
        "77a90307": (A, e, g) => {
            "use strict";
            g.d(e, {
            ...
            var t = g("dc6d28ff");
            const n = () => (0, t.getRequestContext)().getBPlatformEnvironment && "dqs" === (0, t.getRequestContext)().getBPlatformEnvironment(),
                a = () => (0, t.getRequestContext)().getBPlatformEnvironment && ("dev" === (0, t.getRequestContext)().getBPlatformEnvironment() || !(0, t.getRequestContext)().getBPlatformEnvironment());
        ...
        af1e2b38: (A, e, g) => {
            ...
            var t = g("5245e060"),
                n = g("dc6d28ff");
            const a = () => (0, n.getRequestContext)().getSiteType() ? ? t.N.WWW,
                r = () => {
                    const A = a();
                    return {
                        isWWW: A === t.N.WWW,
        ...
        c66f4a5f: (A, e, g) => {
            ...
            g("41c6c66e");
            var t = g("77a90307");
            const n = () => (0, t.r8)() || (0, t.Wx)(),
                a = function() {
                    if (n()) {
                        for (var A = arguments.length, e = new Array(A), g = 0; g < A; g++) e[g] = arguments[g];
                        const n = [(0, t.sk)() ? "[Server Warning]" : "[JS Warning]", ...e];
                        console.warn.apply(undefined, n)
                    }
                }
        },
        "1f177249": (A, e, g) => {
            ...
            let t = function(A) {
                return A["5:4"] = "5:4", A["1:1"] = "1:1", A["3:4"] = "3:4", A["3:2"] = "3:2", A["2:3"] = "2:3", A["4:3"] = "4:3", A["2:1"] = "2:1", A["16:9"] = "16:9", A["21:9"] = "21:9", A["4:5"] = "4:5", A["9:16"] = "9:16", A
            }({})
        },
        "94af1fdb": (A, e, g) => {
            "use strict";
            ...
            const d = "dec8e1cdb2",
                ...
                M = "ee99ac284f";
            var X = function(A) {
                return A.Circle = "circle", A.Square = "square", A
            }(X || {});
            const f = A => {
                let {
                    heading: e,
                    ...
                    alt: U,
                    flagAlt: f,
                    shouldAriaHideImage: C = !1,
                    shouldAriaHideImageFlag: V = !1
                } = A;
                const [z, u] = (0, t.useState)(void 0), [h, K] = (0, i.YD)({
                    threshold: 0,
                    triggerOnce: !0
                }), x = (0, E.trackExperiment)(E.exp `OAYRKHMbddbSLAISRaRbAMFRURURHe`), k = (0, S.isFeatureRunning)(S.feature `OAYRKHMbddbSLAISRaRbAMFRURURYUbCBMeOFXPVMHUO`) ? X.Square : X.Circle;
                (0, t.useEffect)((() => {
                    if (a) {
                        let A;
                        try {
                            if (x && k === X.Square) {
                                const A = a.charAt(0).toUpperCase() + a.charAt(1).toLowerCase(),
                                    e = (0, c.hX)({
                                        setName: "images-flags",
                                        assetName: A
                                    }) || "";
                                u(e)
                            } else A = g("a6c91b97")(`./${a}.png`), u(A)
                        } catch {}
                    }
                }), [a, k, x]);
                (0, t.useEffect)((() => {
                ...
                return n().createElement(o.Actionable, {
                    href: l,
                    className: T,
                    onClick: () => {
                        I && I()
                    ...
                    ref: h
                }, n().createElement(o.Scrim, {
                    className: m,
                    borderRadius: 200,
                    backgroundSlot: n().createElement(o.AspectRatio, {
                        ratio: R || s.L["2:1"],
                        width: "100%"
                    }, n().createElement(o.Image, (0, B.Z)({
                        src: r,
                        alt: U
                    }, C && {
                        alt: ""
                        ...
                        attributes: {
                            "data-testid": "destination-post-cards-img-main"
                        }
                    }))),
                    position: "top",
                    attributes: {
                        "data-testid": `destination-postcard-${d}`
                    }
                }, n().createElement(o.Title, {
                    color: "inherit",
                    title: n().createElement(n().Fragment, null, n().createElement("span", {
                        className: `${b} ${(A=>A.split(" ").some((A=>A.length>16)))(e)?D:""}`
                    }, e), x ? k === X.Square ? n().createElement(o.Image, (0, B.Z)({
                        width: "24px",
                        src: z,
                        className: M,
                        alt: f
                        ...
                        attributes: {
                            "data-testid": "destination-post-cards-img-flag--square"
                        }
                    })) : n().createElement(o.Avatar, {
                        countryCode: a,
                        className: M,
                        size: "small",
                        text: f,
                        ariaLabel: f,
                        attributes: {
                            "data-testid": "destination-post-cards-img-flag--circle"
                        }
                    }) : n().createElement(o.Image, (0, B.Z)({
                        width: "24px",
                        src: z,
                        ...
                        attributes: {
                            "data-testid": "destination-post-cards-img-flag"
                        }
                    }))),
                    variant: "headline_2"
                })))
            ...
            var C = g("8ebac256");
            const V = () => n().createElement(o.Stack, {
                gap: 4
            }, n().createElement(o.Stack, {
                direction: "row",
                gap: 4
            }, [0, 1].map((A => n().createElement(o.Stack.Item, {
                grow: !0,
                key: A
            }, n().createElement(o.SkeletonLoader, {
                variant: "box",
                aspectRatio: s.L["2:1"]
            }))))), n().createElement(o.Stack, {
                direction: "row",
                gap: 4
            }, [2, 3, 4].map((A => n().createElement(o.Stack.Item, {
                grow: !0,
                key: A
            }, n().createElement(o.SkeletonLoader, {
                variant: "box",
            ...
            var K = g("2e96c3d5"),
                ...
                k = g("dfb9cb18");
            const J = A => {
                const e = (0, R.getRequestContext)().getBasePageUrl().searchParams,
                    g = (0, k.m)(e),
                    {
                        loading: t,
                        data: n,
                ...
                return a && (0, z.reportError)(a), (A => {
                    var e;
                    let {
                        carouselDML: g,
                        isLoading: t,
                        shouldAdjustImageSize: n
                    } = A;
                    const a = (0, R.getRequestContext)().getCDNOrigin(),
                        r = null === g || void 0 === g ? void 0 : g.destinationRecommendations,
                        i = [],
                        s = A => n ? (A => 0 === A || 1 === A)(A) ? "540x270" : "354x266" : "600x600";
                    return null === r || void 0 === r || null === (e = r.destinations) || void 0 === e || e.forEach(((A, e) => {
                        i.push({
                            heading: (null === A || void 0 === A ? void 0 : A.title) || "",
                            url: (0, u.d)({
                                checkin: null === r || void 0 === r ? void 0 : r.checkin,
                                checkout: null === r || void 0 === r ? void 0 : r.checkout,
                                nbAdults: null === r || void 0 === r ? void 0 : r.nbAdults,
                                nbChildren: null === r || void 0 === r ? void 0 : r.nbChildren,
                                childrenAges: null === r || void 0 === r ? void 0 : r.childrenAges,
                                nbRooms: null === r || void 0 === r ? void 0 : r.nbRooms,
                                destId: null === A || void 0 === A ? void 0 : A.destId,
                                destType: null === A || void 0 === A ? void 0 : A.destType
                            }).toString(),
                            imgSrc: (0, h.Z)(null === A || void 0 === A ? void 0 : A.imageUrl, s(e), a) || "",
                            flagAlt: null === A || void 0 === A ? void 0 : A.countryName,
                            id: (null === A || void 0 === A ? void 0 : A.destId) || 0,
                            countryCode: (null === A || void 0 === A ? void 0 : A.countryCode) || ""
                        })
                    })), {
                        heading: (null === r || void 0 === r ? void 0 : r.title) || "",
                        subHeading: (null === r || void 0 === r ? void 0 : r.subtitle) || "",
                        isWarmStart: (null === r || void 0 === r ? void 0 : r.isWarmStart) || !1,
                        items: i,
                        isLoading: t
                    }
                })({
            ...
            (0, Y.dg)();
            const L = () => {
                const A = E.exp `cCHObTULHfAFFQZcNHFXbEIdAJOdKNKNKWe`,
                    e = E.exp `OAYRKHMdReLDEZREScXQOVZQOQCXNLOLOLMO`,
                    g = !!(0, E.trackExperiment)(A),
                    t = J(g),
                    a = t.heading,
                    B = t.subHeading,
                    c = null === t || void 0 === t ? void 0 : t.items,
                    S = t.isWarmStart,
                    T = "us" === (0, R.getRequestContext)().getVisitorCountry(),
                    m = null === c || void 0 === c ? void 0 : c.slice(0, 2),
                    b = null === c || void 0 === c ? void 0 : c.slice(2, 5),
                    D = 2 === (null === m || void 0 === m ? void 0 : m.length),
                    M = 3 === (null === b || void 0 === b ? void 0 : b.length),
                    X = null === c || void 0 === c ? void 0 : c.map((A => ({
                        ufi: A.id
                    }))),
                    z = g => {
                        var t, n;
                        t = g, n = X || [], C.Z.sendEvent({
                        ...
                        }), (0, E.trackCustomGoal)(A, 1), (0, E.trackCustomGoal)(e, 3), (0, w.Ht)(), (0, j.uB)(), T || (S ? (0, E.trackCustomGoal)(E.exp `OAYRKHMdReLDEZRdHeSaeZTUPACQKGUUZaTCCDdKNKNKWe`, 1) : (0, E.trackCustomGoal)(E.exp `OAYRKHMdReLDEZRdHeSaeZTUPACQKGUUHGaQFRURURHe`, 1)), (0, E.trackCustomGoal)(E.exp `OAYRKHMbddbSLAISRaRbAMFRURURHe`, 1)
                    };
                if (t.isLoading && 0 === (null === c || void 0 === c ? void 0 : c.length)) return null;
                if (!t.isLoading) {
                    if (!D) return null;
                    (0, E.trackExperimentStage)(E.exp `OAYRKHMbddbSLAISRaRbAMFRURURHe`, 1), T && (0, E.trackExperimentStage)(E.exp `OAYRKHMbddbSLAISRaRbAMFRURURHe`, 2)
                }
                const u = a && D,
                    h = s.L["4:3"];
                return n().createElement(i.df, {
                    onChange: e => {
                        var g;
                        e && null !== X && void 0 !== X && X.length && (g = X, C.Z.sendEvent({
                            action_name: "webcoreux.destination_recommender_viewed",
                            action_version: "1.0.0",
                            content: {
                                postcards: g
                            }
                        })), e && ((0, E.trackCustomGoal)(E.exp `OAYRKHMbddbSLAISRaRbAMFRURURHe`, 2), (0, E.trackExperimentStage)(A, 1), T || (S ? ((0, E.trackExperimentStage)(E.exp `OAYRKHMdReLDEZRdHeSaeZTUPACQKGUUZaTCCDdKNKNKWe`, 3), (0, E.trackCustomGoal)(E.exp `OAYRKHMdReLDEZRdHeSaeZTUPACQKGUUZaTCCDdKNKNKWe`, 2)) : ((0, E.trackExperimentStage)(E.exp `OAYRKHMdReLDEZRdHeSaeZTUPACQKGUUHGaQFRURURHe`, 3), (0, E.trackCustomGoal)(E.exp `OAYRKHMdReLDEZRdHeSaeZTUPACQKGUUHGaQFRURURHe`, 2))))
                    },
                    className: "keep"
                }, t.isLoading ? n().createElement(V, null) : n().createElement(n().Fragment, null, u ? n().createElement("div", {
                    className: l,
                    ...
                    variant: "headline_2",
                    titleTagName: "h2"
                })) : null, D && n().createElement("div", {
                    className: r()(d, {
                        [I]: !M && !(0, H.Y$)()
                    }),
                    "data-testid": "destination-postcards-firstrow",
                    onClick: () => (0, E.trackGoal)("www_destination_postcard_click"),
                    role: "none"
                }, null === m || void 0 === m ? void 0 : m.map((A => {
                    let {
                        heading: e,
                        imgSrc: g,
                        countryCode: t,
                ...
                }, null === b || void 0 === b ? void 0 : b.map((A => {
                    let {
                        heading: e,
                        imgSrc: g,
                        countryCode: t,
        ...
        "6e327bdc": (A, e, g) => {
            ...
            var t = g("af1e2b38"),
                ...
                a = g("28dbd132"),
                r = g("e36d8828");
            const i = () => "us" === (0, n.getRequestContext)().getVisitorCountry(),
                s = a.exp `OABBaJTWZdJNAHVYDYWXVFcSQLOLOLMO`,
                o = a.exp `OABBaJTWZdJNAHVYDYWXVFcSLBBVYYT`;
            let R = function(A) {
                    return A[A.QMAB_ON_VIEW = 1] = "QMAB_ON_VIEW", A[A.GENIUS_USER = 2] = "GENIUS_USER", A[A.SIGNED_OUT = 3] = "SIGNED_OUT", A[A.COLD_START_USER = 4] = "COLD_START_USER", A[A.WARM_START_USER = 5] = "WARM_START_USER", A[A.WARM_START_INTERNATIONAL_USER = 6] = "WARM_START_INTERNATIONAL_USER", A[A.WARM_START_DOMESTIC_USER = 7] = "WARM_START_DOMESTIC_USER", A[A.US_USER = 8] = "US_USER", A
                }({}),
                E = function(A) {
                    return A[A.ON_VIEW_TRENDING_DESTINATION = 1] = "ON_VIEW_TRENDING_DESTINATION", A[A.ON_CLICK_TRENDING_DESTINATION = 2] = "ON_CLICK_TRENDING_DESTINATION", A[A.ON_VIEW_HOMES_GUESTS_LOVE = 3] = "ON_VIEW_HOMES_GUESTS_LOVE", A[A.ON_CLICK_HOMES_GUESTS_LOVE = 4] = "ON_CLICK_HOMES_GUESTS_LOVE", A
                }({});
            const B = () => {
                    const {
                        isWWW: A
                ...
                c = () => (0, a.trackExperiment)(B()) > 0,
                S = () => {
                    i() && (0, a.trackCustomGoal)(B(), E.ON_CLICK_HOMES_GUESTS_LOVE)
                },
                d = () => {
                    i() && (0, a.trackCustomGoal)(B(), E.ON_CLICK_TRENDING_DESTINATION)
                },
                l = A => {
                    const {
                        isColdStartUser: e,
                        isInternationalUser: g,
                        isUsUser: t
                    } = A, n = B();
                    (0, a.trackExperimentStage)(n, R.QMAB_ON_VIEW), (0, r.jl)() ? (0, a.trackExperimentStage)(n, R.GENIUS_USER) : (0, a.trackExperimentStage)(n, R.SIGNED_OUT), e ? (0, a.trackExperimentStage)(n, R.COLD_START_USER) : !1 === e && ((0, a.trackExperimentStage)(n, R.WARM_START_USER), g ? (0, a.trackExperimentStage)(n, R.WARM_START_INTERNATIONAL_USER) : !1 === g && (0, a.trackExperimentStage)(n, R.WARM_START_DOMESTIC_USER)), t && (0, a.trackExperimentStage)(n, R.US_USER)
                }
        },
        "52ffbfd1": (A, e, g) => {
            "use strict";
            ...
            var t = g("af1e2b38"),
                n = g("28dbd132");
            const a = n.exp `OABBaJcBHQQWcGHVHNEIMUKVBBVYYT`,
                r = n.exp `OABBaJcBHQQWcGHVHNEIMUKALOLOLMO`,
                i = () => (0, n.trackExperiment)(a) > 0,
                s = () => (0, n.trackExperiment)(r) > 0,
                o = () => {
                    const {
                        isMDOT: A
                    } = (0, t.Z6)();
                ...
                E = () => {
                    (0, n.trackCustomGoal)(R(), 1)
                },
                B = () => {
                    (0, n.trackCustomGoal)(R(), 2)
                },
                c = () => {
                    if ("undefined" === typeof window || "undefined" === typeof document) return;
                    const A = "js_index_queenmab_rendered_components_count",
                        e = o();
                    setTimeout((function() {
                        e ? g() : t()
                    }), 5e3);
                    const g = () => {
                            const e = Array.from(document.querySelectorAll("[data-widgetid]")).map((A => {
                                var e;
                                return (null === A || void 0 === A || null === (e = A.textContent) || void 0 === e ? void 0 : e.trim()) || ""
                            })).filter((A => A.length > 0)).length;
                            (0, n.trackGoalWithValue)(A, e)
                        },
                        t = () => {
                            const e = Array.from(document.querySelectorAll("[data-qmab-component-id]")).map((A => {
                                var e;
                                return (null === A || void 0 === A || null === (e = A.textContent) || void 0 === e ? void 0 : e.trim()) || ""
                            })).filter((A => A.length > 0)).length;
                            (0, n.trackGoalWithValue)(A, e)
        ...
        "6ff170fe": (A, e, g) => {
            ...
            var t = g("af1e2b38"),
                ...
                r = g("e36d8828");
            const i = () => "us" === (0, n.getRequestContext)().getVisitorCountry(),
                s = a.exp `OABBaJdUBfUaRIfMPePcAFRFGUNTBBSSUFRURURHe`,
                o = a.exp `OABBaJdUBfUaRIfMPePcAFRFGUNTBBSSUWPHDDWe`;
            let R = function(A) {
                    return A[A.NON_BOT_US_USER = 1] = "NON_BOT_US_USER", A[A.COLD_START_US_USER = 2] = "COLD_START_US_USER", A[A.WARM_START_US_USER = 3] = "WARM_START_US_USER", A[A.DIRECT_TRAFFIC = 4] = "DIRECT_TRAFFIC", A[A.PAID_TRAFFIC = 5] = "PAID_TRAFFIC", A[A.GENIUS_USER = 6] = "GENIUS_USER", A[A.QMAB_ON_VIEW = 7] = "QMAB_ON_VIEW", A[A.ELIGIBLE_US_USERS = 8] = "ELIGIBLE_US_USERS", A[A.HAS_UPCOMING_BOOKINGS = 9] = "HAS_UPCOMING_BOOKINGS", A
                }({}),
                E = function(A) {
                    return A[A.ON_CLICK_HOMES_GUESTS_LOVE = 1] = "ON_CLICK_HOMES_GUESTS_LOVE", A[A.ON_CLICK_TRENDING_DESTINATION = 2] = "ON_CLICK_TRENDING_DESTINATION", A[A.ON_CLICK_DOMESTIC_DESTINATION = 3] = "ON_CLICK_DOMESTIC_DESTINATION", A[A.ON_CLICK_WEEKEND_DEALS = 4] = "ON_CLICK_WEEKEND_DEALS", A[A.ON_CLICK_SIGNUP = 5] = "ON_CLICK_SIGNUP", A
                }({});
            const B = () => {
                    const {
                        isWWW: A
                ...
                S = (A, e, g) => {
                    const t = B();
                    i() && ((0, a.trackExperimentStage)(t, R.NON_BOT_US_USER), (0, r.jl)() && (0, a.trackExperimentStage)(t, R.GENIUS_USER), e && ((0, a.trackExperimentStage)(t, R.ELIGIBLE_US_USERS), g ? (0, a.trackExperimentStage)(t, R.COLD_START_US_USER) : (0, a.trackExperimentStage)(t, R.WARM_START_US_USER)), (() => {
                        const {
                            partnerChannelId: A
                        } = (0, n.getRequestContext)().getAffiliate() ? ? {};
                        return A && [4, 14].includes(A)
                    })() ? (0, a.trackExperimentStage)(t, R.PAID_TRAFFIC) : (0, a.trackExperimentStage)(t, R.DIRECT_TRAFFIC), A && (0, a.trackExperimentStage)(t, R.HAS_UPCOMING_BOOKINGS))
                },
                d = () => {
                    i() && (0, a.trackCustomGoal)(B(), E.ON_CLICK_HOMES_GUESTS_LOVE)
                },
                ...
                I = () => {
                    i() && (0, a.trackCustomGoal)(B(), E.ON_CLICK_DOMESTIC_DESTINATION)
                },
                p = () => {
                    i() && (0, a.trackCustomGoal)(B(), E.ON_CLICK_WEEKEND_DEALS)
                }
        },
        "2e96c3d5": (A, e, g) => {
            "use strict";
        ...
        "3d486da1": (A, e, g) => {
            ...
            function s(A, e) {
                let g = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0;
                if (isNaN(A)) return "";
                const t = e in a,
                    n = t ? "." : ",";
                let s = t ? "," : ".";
                e in r && (s = " ");
                const o = Math.pow(10, g),
                    R = (Math.round(A * o) / o).toFixed(g),
                    E = R.split(".")[0],
                    B = R.split(".")[1];
                return E.replace(i, `$1${s}`) + (B ? n + B : "")
            }
            const o = A => {
                    const e = [{
                        from: null,
                        to: 3,
                        copy: (0, n.t)("review_adj_very_poor")
                    }, {
                        from: 3,
                        to: 4,
                        copy: (0, n.t)("review_adj_poor")
                    }, {
                        from: 4,
                        to: 5,
                        copy: (0, n.t)("review_adj_disappointing")
                    }, {
                        from: 5,
                        to: 5.6,
                        copy: (0, n.t)("review_adj_average")
                    }, {
                        from: 5.6,
                        to: 6,
                        copy: (0, n.t)("review_adj_above_average")
                    }, {
                        from: 6,
                        to: 7,
                        copy: (0, n.t)("review_adj_pleasant")
                    }, {
                        from: 7,
                        to: 8,
                        copy: (0, n.t)("review_adj_good")
                    }, {
                        from: 8,
                        to: 8.6,
                        copy: (0, n.t)("review_adj_very_good")
                    }, {
                        from: 8.6,
                        to: 9,
                        copy: (0, n.t)("review_adj_fabulous")
                    }, {
                        from: 9,
                        to: 9.5,
                        copy: (0, n.t)("review_adj_superb")
                    }, {
                        from: 9.5,
                        to: null,
                        copy: (0, n.t)("review_adj_exceptional")
                    }];
                    for (const g of e)
                        if (!(g.from && g.from > A) && !(g.to && g.to <= A)) return {
                            ratingAdjective: g.copy
                        };
                    throw new Error("score range is missed")
                },
                R = () => {
                    const A = (0, t.getRequestContext)().getBPlatformEnvironment();
                    return A && "dev" !== A && "dqs" !== A ? "prod" : "dqs"
                },
                E = (A, e, g) => {
                    if (void 0 !== e && void 0 !== g) return {
                        score: e.toFixed(1),
                        rating: A.trans(o(e).ratingAdjective),
                        reviewCount: A.trans((0, n.t)("num_reviews_sr_page", {
                            variables: {
                                num_reviews: s(g, A.language),
                                num_exception: g || ""
                            }
                        }))
                    }
                ...
                B = A => ({
                    formattedScore: (null === A || void 0 === A ? void 0 : A.score) || "",
                    formattedReviewCount: null === A || void 0 === A ? void 0 : A.reviewCount,
                    rating: (null === A || void 0 === A ? void 0 : A.rating) || "",
                    ariaLabel: (null === A || void 0 === A ? void 0 : A.score) || "",
                    ratingReviewAriaLabel: (null === A || void 0 === A ? void 0 : A.rating) || ""
                }),
                c = (A, e) => {
                    if (A) return {
                        text: e.trans((0, n.t)("m_sr_distance_from_centre", {
                            variables: {
                                distanceInKmFromCentre: A
                            }
                        })) || "",
                        iconName: "GeoPinIcon"
                    }
                },
                S = A => [null === A || void 0 === A ? void 0 : A.translatedCityName, null === A || void 0 === A ? void 0 : A.translatedDistrictName].filter(Boolean).join(", ") || ""
        },
        "2bb3685b": (A, e, g) => {
            "use strict";
            g.d(e, {
            ...
            const t = "b_merch_test_campaign_id",
                n = "b_genius_data_debug",
        ...
        "2db41414": (A, e, g) => {
            ...
            const n = (A, e, g, n) => {
                    const a = t.J[n][e][g];
                    return A ? {
                        "1x": A.replace("<SIZE>", a["1x"]),
                        "2x": A.replace("<SIZE>", a["2x"])
                    } : null
                },
                a = (A, e, g) => A && g + A.replace("<SIZE>", e)
        },
        "5c4eda5e": (A, e, g) => {
            "use strict";
            g.d(e, {
            ...
            let t = function(A) {
                return A.IndexQmabDesktop = "IndexQmabDesktop", A.IndexQmabMdot = "IndexQmabMdot", A
            }({});
            const n = {
                IndexQmabDesktop: {
                    small: {
        ...
        e36d8828: (A, e, g) => {
            ...
            var t = g("43a4d203"),
                n = g("dc6d28ff");
            const a = () => (0, n.getRequestContext)().getUnpackedGuestAccessToken(),
                r = () => {
                    var A;
                    const e = null === (A = a()) || void 0 === A ? void 0 : A.authenticatorAssuranceLevel;
                    return !!e && e >= t.AuthenticatorAssuranceLevel.AAL1
                },
                i = () => {
                    var A;
                    return !(null === (A = a()) || void 0 === A || !A.isMarketingTrackingAllowed)
                },
                s = () => !r()
        },
        "5db8920d": (A, e, g) => {
            ...
            var t = g("3d486da1");
            const n = function() {
                let A = arguments.length > 1 ? arguments[1] : void 0;
                const e = "dqs" === (0, t.dU)() ? 3e4 : 1500;
                return {
                    "X-Booking-Timeout-Ms": A ? ? e,
                    "X-Envoy-Expected-Rq-Timeout-Ms": A ? ? e,
                    "X-Booking-Timeout-Budget-Ms": A ? ? e
                }
            }
        },
        "8e166592": (A, e, g) => {
            ...
            const r = () => {
                ...
                const e = (0, a.getRequestContext)(),
                    g = e.getBPlatformEnvironment(),
                    t = e.getSiteType(),
                    r = String(null === (A = e.getAffiliate()) || void 0 === A ? void 0 : A.id),
                    i = {
                        lang: e.getLanguage(),
            ...
            let i = function(A) {
                return A.Click = "CLICK", A.View = "VIEW", A
            }({});
            const s = (A, e) => {
                var g;
                if (!e) return;
                const a = null === (g = e.c360Actions) || void 0 === g ? void 0 : g.find((e => (null === e || void 0 === e ? void 0 : e.actionType) === A));
                if (!a) return;
                let r = {};
                try {
                    r = JSON.parse(a.content)
                } catch (i) {
                    return void(0, t.ZK)("content in C360 tracking action is not a valid JSON")
                }
                n.Z.sendEvent({
        ...
        dfb9cb18: (A, e, g) => {
            ...
            var t = g("3d486da1"),
                n = g("2bb3685b");
            const a = A => 0 === Object.keys(A).length || "prod" === (0, t.dU)() ? {} : {
                    "X-Booking-Dev-Service-Override": JSON.stringify(A)
                },
                r = A => {
                    const e = {};
                    return n.gh.forEach((g => {
                        const t = A.get(`dev_${g}`);
                        t && (e[g] = t)
                    })), e
                }
        },
        "8ebac256": (A, e, g) => {
            ...
            function t(A, e, g, t) {
                return new(g || (g = Promise))((function(n, a) {
                    function r(A) {
                        try {
                            s(t.next(A))
                        } catch (e) {
                    ...
                    function s(A) {
                        var e;
                        A.done ? n(A.value) : (e = A.value, e instanceof g ? e : new g((function(A) {
                            A(e)
                        }))).then(r, i)
                    }
            ...
            class n {
                constructor(A) {
                    this.config = A, this.headers = this.config.API.HEADERS
                }
                get(A, e) {
                    return new Promise(((g, n) => t(this, void 0, void 0, (function*() {
                        try {
                ...
                post(A, e, g) {
                    return new Promise(((n, a) => t(this, void 0, void 0, (function*() {
                        try {
                            const t = yield fetch(A, {
                                method: "POST",
                                headers: (null === g || void 0 === g ? void 0 : g.withHeaders) ? this.headers : void 0,
                                credentials: !1 === (null === g || void 0 === g ? void 0 : g.withCredentials) ? "omit" : "include",
            ...
            var a = new class {
                ...
                post(A) {
                    ...
                    return t(this, void 0, void 0, (function*() {
                        return this.client.post(A, e, g)
                    }))
                }
            };
            const r = A => {
                var e = void 0;
                A.platform || (A.platform = ""), A.platform = A.platform.toLowerCase(), "mdot" == A.platform && (e = 2), "ddot" != A.platform && "www" != A.platform || (e = 1);
                return {
            ...
            class i {
                constructor(A, e, g) {
                    this.batchSize = A, this.queueLimit = e, this.queue = [], this.timeoutId = null, this.sendBatchFn = g
                }
                enqueue(A) {
                    this.queue.push(A), this.queue.length >= this.batchSize ? this.flush() : 1 !== this.queue.length || this.timeoutId || (this.timeoutId = setTimeout((() => {
                        this.processQueue()
                    }), this.queueLimit))
                }
                flush(A) {
                    clearTimeout(this.timeoutId), this.processQueue(A)
                }
                processQueue(A) {
                    let e = [];
                    e = this.queue.length >= this.queueLimit ? this.queue.splice(0) : this.queue.splice(0, this.batchSize), this.sendBatchFn(e), this.queue.length > 0 ? this.processQueue() : this.timeoutId = null
                }
            }
            const s = new class {
                constructor() {
                    this.trackBatch = A => t(this, void 0, void 0, (function*() {
                        this.track({
                            events: A.map((A => function(A, e, g) {
                                const t = {
                                    local: {
                                        currency: e.currency,
                                        language: e.language
                                ...
                                "undefined" != typeof window && (t.page = {
                                ...
                                return g && (n.tracker_version = "0.1.1"), Object.assign(Object.assign({}, A), {
                                    context: t,
                                    tracker: n
                                })
                            }(A, this.c360Config, !0)))
                ...
                init(A) {
                    this.c360Config = (A => {
                        const e = A.hostname || (A.isDev ? "app.dqs.booking.com" : "www.booking.com");
                        return {
                            IS_DEV: Boolean(A.isDev),
                            API: {
                                HEADERS: r(A)
                            },
                            TRACK_BASE_URL: `https://${e}/c360/v1/track`,
                            language: A.lang,
                            currency: A.currency
                        }
                    })(A), this.httpClient = a, this.c360url = this.c360Config.TRACK_BASE_URL, this.props = A, this.batchQueue = this.batchQueue || new i(10, 1e3, this.trackBatch), a.init(this.c360Config)
                }
                track(A) {
                    return t(this, void 0, void 0, (function*() {
                        this.httpClient.post(this.c360url, A, {
                            ...
                            this.props.onErrorCallback && this.props.onErrorCallback(new Error(A))
                        }))
                    }))
                }
                sendEvent(A, e) {
                    return t(this, void 0, void 0, (function*() {
                        this.batchQueue.enqueue(A), e && this.batchQueue.flush()
                    }))
                }
            }
        },
        ...
        dd6086f7: (A, e, g) => {
            ...
            function i(A) {
                let {
                    ...
                    showApartHotels: f,
                    loginRedirect: C,
                    fromSearchHistorySearchbox: V,
                    lpThemeId: z,
                    previousSearchId: u,
                    srView: h,
                    sourceLabel: K
                } = A;
                const x = (0, t.getRequestContext)().getLanguage(),
                    k = (0, n.constructUrl)({
                        pathname: `/searchresults${"en-us"===x?"":"."+x}.html`
                    }),
                    J = k.searchParams;
                if (p && U && (J.set("checkin", p), J.set("checkout", U)), E && R && (J.set("dest_id", String(E)), J.set("dest_type", String(R).toLowerCase())), "boolean" === typeof B && J.set("is_aroundme", B ? "1" : "0"), "undefined" !== typeof c && "undefined" !== typeof S && (J.set("latitude", String(c)), J.set("longitude", String(S))), "undefined" !== typeof d) {
                    const A = (0, a.DT)(parseInt(String(d), 10));
                    A && J.set(a.w3, A)
                }
                return I && J.set(r.mT, I), l && J.set("order", l), "undefined" !== typeof T && (J.set("group_adults", String(T)), J.set("req_adults", String(T))), "undefined" !== typeof D && J.set("no_rooms", String(D)), "undefined" !== typeof m && (J.set("group_children", String(m)), J.set("req_children", String(m))), b && b.forEach((A => {
                    J.append("age", String(A)), J.append("req_age", String(A))
                })), s && J.set("highlighted_hotels", String(s)), o && J.set("trip_theme", String(o)), e && J.set("ucfac", e), g && J.set("ucfgff", g), i && J.set("ffsau", i), M && J.set("postcard", M), X && J.set("slp_r_match_to", X), f && J.set("shw_aparth", f), C && J.set("login_redirect", C), V && J.set("fshsb", "1"), z && J.set("theme_id", String(z)), u && J.set(r.jP, u), h && J.set("sr_view", h), K && J.set("source_label", K), k
            }
        },
        67934118: (A, e, g) => {
            "use strict";
        ...
        "125a0ea0": (A, e, g) => {
            "use strict";
            A.exports = g.p + "static/media/aq.2e549b95.png"
        },
        e6dce2b6: A => {
            "use strict";
        ...
        "38f97126": (A, e, g) => {
            "use strict";
            A.exports = g.p + "static/media/bl.44d9e344.png"
        },
        a489fcfc: A => {
            "use strict";
        ...
        fee45f7e: (A, e, g) => {
            "use strict";
            A.exports = g.p + "static/media/io.7729d67a.png"
        },
        "5e442242": A => {
            "use strict";
        ...
        "56fa7774": (A, e, g) => {
            "use strict";
            A.exports = g.p + "static/media/je.52601cb9.png"
        },
        "48e2c15b": A => {
            "use strict";
        ...
        f4430455: (A, e, g) => {
            "use strict";
            A.exports = g.p + "static/media/pm.6b1392d5.png"
        },
        edf95af3: A => {
            "use strict";
        ...
        "641beee2": (A, e, g) => {
            "use strict";
            A.exports = g.p + "static/media/ve.a7f1a604.png"
        },
        "7885ddcf": A => {
            "use strict";
        ...
        "8521b397": (A, e) => {
            ...
            ! function() {
                ...
                function a(A) {
                    ...
                    var e = "";
                    for (var g in A) t.call(A, g) && A[g] && (e = r(e, g));
                    return e
                }

                function r(A, e) {
                    return e ? A ? A + " " + e : A + e : A
                }
                A.exports ? (n.default = n, A.exports = n) : void 0 === (g = function() {
                    return n
                }.apply(e, [])) || (A.exports = g)
            }()
        },
        "9a67ad93": (A, e, g) => {
            ...
            function R(A) {
                return Object.keys(A).sort().filter((e => void 0 !== A[e])).map((e => {
                    return `${e}_${"root"===e?(g=A.root,g?(i.has(g)||(s+=1,i.set(g,s.toString())),i.get(g)):"0"):A[e]}`;
                    var g
                })).toString()
            }
            ...
            function E(A, e) {
                let g = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                    t = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : o;
                if ("undefined" === typeof window.IntersectionObserver && void 0 !== t) {
                    const n = A.getBoundingClientRect();
                    return e(t, {
                        isIntersecting: t,
                        target: A,
                        intersectionRatio: "number" === typeof g.threshold ? g.threshold : 0,
                        time: 0,
                ...
                const {
                    ...
                    if (!g) {
                        ...
                        const a = new IntersectionObserver((e => {
                            e.forEach((e => {
                                var g;
                                const a = e.isIntersecting && n.some((A => e.intersectionRatio >= A));
                                A.trackVisibility && "undefined" === typeof e.isVisible && (e.isVisible = a), null == (g = t.get(e.target)) || g.forEach((A => {
                                    A(a, e)
                                }))
                            }))
                        }), A);
                        n = a.thresholds || (Array.isArray(A.threshold) ? A.threshold : [A.threshold || 0]), g = {
                            id: e,
                            observer: a,
                            elements: t
                        }, r.set(e, g)
                ...
                return i.has(A) || i.set(A, s), s.push(e), a.observe(A),
                    function() {
                        s.splice(s.indexOf(e), 1), 0 === s.length && (i.delete(A), a.unobserve(A)), 0 === i.size && (a.disconnect(), r.delete(n))
                    }
            }
            var B = class extends t.Component {
                constructor(A) {
                    super(A), a(this, "node", null), a(this, "_unobserveCb", null), a(this, "handleNode", (A => {
                        this.node && (this.unobserve(), A || this.props.triggerOnce || this.props.skip || this.setState({
                            inView: !!this.props.initialInView,
                            entry: void 0
                        })), this.node = A || null, this.observeNode()
                    })), a(this, "handleChange", ((A, e) => {
                        A && this.props.triggerOnce && this.unobserve(),
                            function(A) {
                                return "function" !== typeof A.children
                            }(this.props) || this.setState({
                                inView: A,
                                entry: e
                            }), this.props.onChange && this.props.onChange(A, e)
                    })), this.state = {
                ...
                observeNode() {
                    ...
                    this._unobserveCb = E(this.node, this.handleChange, {
                        threshold: A,
                        root: e,
                        rootMargin: g,
                        trackVisibility: t,
            ...
            function c() {
                ...
                var B;
                const [c, S] = t.useState(null), d = t.useRef(), [l, I] = t.useState({
                    inView: !!s,
                    entry: void 0
                });
                d.current = R, t.useEffect((() => {
                    if (i || !c) return;
                    let t;
                    return t = E(c, ((A, e) => {
                        I({
                            inView: A,
                            entry: e
                        }), d.current && d.current(A, e), e.isIntersecting && r && t && (t(), t = void 0)
                    }), {
                        root: a,
                        rootMargin: n,
                        threshold: A,
                ...
                }), [Array.isArray(A) ? A.toString() : A, c, a, n, r, i, g, o, e]);
                const p = null == (B = l.entry) ? void 0 : B.target,
                    U = t.useRef();
                c || !p || r || i || U.current === p || (U.current = p, I({
                    inView: !!s,
                    entry: void 0
                }));
                const T = [S, l.inView, l.entry];
                return T.ref = T[0], T.inView = T[1], T.entry = T[2], T
            }
        }
    }
]);
//# sourceMappingURL=https://istatic.booking.com/internal-static/capla/static/js/ace575b5.c42e9f72.chunk.js.map